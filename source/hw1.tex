...
\begin{itemize}
    ...
    \item Solve the log probability equation \eqref{eq:logprobability} backward in time. The solution at time $t= 0$ is given by $\log\rho_0(x_0),$ where $\varphi^1(x_0) = x_1.$ You can evaluate $\log\rho_0$ anywhere since $\rho_0$ is a Gaussian distribution. 
